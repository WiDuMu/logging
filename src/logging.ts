...
/** Object configuration for logging.dir(). */
type DirOptions = {
   /** Whether to style the properties of an object according to type. Defaults to `true`.  */
   colors: boolean,
   /** Depth of properties to log. Defaults to `2`. */
   depth: number,
   /** Show hidden, non-enumarable, and symbol properties. Defaults to `false` */
   showHidden: boolean 
}
...
export default class logging {
   /** Whether to actually log the calls */
    ...
    */
   static assert(condition: boolean, ...params: any[]) {
      if (logging.enabled) {
    ...
    */
   static count(label: string | undefined) {
      if (logging.enabled) {
         console.count(label);
      }
   }
   ...
   */
   static countReset(label: string | undefined) {
      if (logging.enabled) {
    ...
    */
   static dir(object: Object, options: DirOptions) {
      if (logging.enabled) {
   ...
   */
    ...
    */
   static group(label: string | undefined) {
      if (logging.enabled) {
         console.group(label);
      }
   }
    ...
    * @param {string | undefined} label - The group's label
    */
   static groupCollapsed(label: string | undefined) {
      if (logging.enabled) {
    ...
    */
   static profile(name: string | undefined) {
    ...
    */
   static profileEnd(name: string | undefined) {
    ...
    */
   static table(tabularData: Object | any[], columns: string[] | undefined) {
      if (logging.enabled) {
    ...
    */
   static time(label: string | undefined) {
      if (logging.enabled) {
         console.time(label);
      }
   }
    ...
    */
   static timeEnd(label: string | undefined) {
      if (logging.enabled) {
    ...
    */
   static timeLog(label: string | undefined, ...params: any[]) {
      if (logging.enabled) {
    ...
    */
   static timeStamp(label: string | undefined) {
